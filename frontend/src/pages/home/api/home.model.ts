...
export type DateItem = { id:string; title:string; startsAt:string|null; eventDate:string|null; isAllDay:boolean; organizerMode:OrganizerMode; requestedWindow?:RequestedWindow|null; createdBy:string; organizerComment:string|null; status:'planned'|'completed'|'cancelled'; typeTitle:string; emoji:string; photos:{id:string;filename:string}[] };
...
export type Notification = { id:string; body:string; dateId:string|null; createdAt:string; readAt:string|null };
